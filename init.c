...
BOOL WINAPI DllMain(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpvReserved) {
    switch(fdwReason) {
        case DLL_PROCESS_ATTACH: register_os_init(); if (constructor) constructor(); break;
...
__attribute__((constructor)) static void __os_register(void) { register_os_init(); if (constructor != NULL) constructor(); }
